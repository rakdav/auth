...
public class JWTTokenProvider
{
    ...
    public String generateToken(Authentication authentication){
        ...
        return Jwts.builder().setSubject(userId).addClaims(claimsMap).setIssuedAt(now).
                setExpiration(expiryDate).signWith(SignatureAlgorithm.ES512,SecurityConstants.SECRET).
                compact();
    }
